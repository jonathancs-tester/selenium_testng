...
public class EditCustomerCustomer extends TestCase implements IConstants {
  ...
  public void testLoginNG() throws Exception {
	...
	selenium.pdf = new GeneratePDF(data.getpathPDFAdmin(), TEST_CASE_9+"_"+ date + ".pdf");
	...
	try{ 
		...
		selenium.driver.findElement(By.id("formCustomer:customersTable:customerName:filter")).clear();
	    selenium.driver.findElement(By.id("formCustomer:customersTable:customerName:filter")).sendKeys("AddCustomer");
	    Thread.sleep(500);
	    ...
	    selenium.driver.findElement(By.id("formCustomerRoles:customerName")).sendKeys("EditCustomer");
	    selenium.driver.findElement(By.id("formCustomerRoles:customerBriefName")).sendKeys("2");
	    ...
	    selenium.driver.findElement(By.id("formCustomerRoles:customerAccName_input")).sendKeys("Digicel");
	    selenium.driver.findElement(By.xpath("//div[@id='formCustomerRoles:customerAccName_panel']/ul/li")).click();
	    
	    /*selenium.waitComponent("path",selenium, "//span[@id='formCustomerRoles:idCustomerCountry']/button");
	    
	    selenium.driver.findElement(By.xpath("//span[@id='formCustomerRoles:idCustomerCountry']/button")).click();	    
	    selenium.driver.findElement(By.xpath("//div[@id='formCustomerRoles:idCustomerCountry_panel']/ul/li[2]")).click();
	    ...
	    */
	    ...
	    assertEquals("Success to save EditCustomer", selenium.driver.findElement(By.xpath("//div[@id='messages_growl_container']/div/div/div[2]/p")).getText());
	    Thread.sleep(500);
	    selenium.printScreenshot();
	    
    	selenium.resultPassed(TEST_CASE_9,date,"admin");
		
		}catch(Error | Exception e){
			selenium.printScreenshot();
			selenium.resultFailed(e.getMessage().toString(),TEST_CASE_9, date,"admin");
			e.printStackTrace();
		}finally{
		ExecutionResult.reportTestCaseResult(PROJECT, TEST_PLAN, TEST_CASE_9, data.getbuild(), selenium.exceptionNote, selenium.result);
	}
}
